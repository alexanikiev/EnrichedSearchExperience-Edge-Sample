...
interface ISettingHelpProps {
}

interface ISettingHelpState {
}

class SettingHelp extends Component<ISettingHelpProps, ISettingHelpState> {
    
    constructor(props: ISettingHelpProps) {
        super(props);
    }
    ...
    render() {
        return (
            <div>
                SettingHelp: Page is under construction
                <br/>
